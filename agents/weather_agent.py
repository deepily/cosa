...
if __name__ == "__main__":
    ...
    weather_agent = WeatherAgent( question=ss.remove_non_alphanumerics( question ), last_question_asked=question, routing_command="agent router go to weather", debug=True, verbose=True, auto_debug=True )
