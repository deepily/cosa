...
class CalendaringAgent( AgentBase ):
    ...
    def __init__( self, question: str="", last_question_asked: str="", question_gist: str="", routing_command: str="agent router go to calendar", push_counter: int=-1, user_id: str="ricardo_felipe_ruiz_6bdc", debug: bool=False, verbose: bool=False, auto_debug: bool=False, inject_bugs: bool=False ) -> None:
        """
        ...
        super().__init__( df_path_key="path_to_events_df_wo_root", question=question, question_gist=question_gist, last_question_asked=last_question_asked, routing_command=routing_command, push_counter=push_counter, user_id=user_id, debug=debug, verbose=verbose, auto_debug=auto_debug, inject_bugs=inject_bugs )
