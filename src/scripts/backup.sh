...
SOURCE_DIR="/mnt/DATA01/include/www.deepily.ai/projects/genie-in-the-box/src/cosa/"
DEST_DIR="/mnt/DATA02/include/www.deepily.ai/projects/genie-in-the-box/src/cosa/"
SCRIPT_DIR="$( cd "$( dirname "${BASH_SOURCE[0]}" )" && pwd )"
EXCLUDE_FILE="$SCRIPT_DIR/conf/rsync-exclude.txt"
PROJECT_NAME="COSA (Collection of Small Agents)"
# === CONFIG END ===
